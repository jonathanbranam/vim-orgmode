...
def is_within_week_or_active_todo(heading):
	u"""
	Returns:
		bool: True if heading contains an active TODO or the date is within a
			week.
	"""
	return is_within_week(heading) or contains_active_todo(heading)
